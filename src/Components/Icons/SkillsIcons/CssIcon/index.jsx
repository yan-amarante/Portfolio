function CssIcon() {
    ...
    return (
        ...
        <svg fill="#ffffff" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns: xlink="http://www.w3.org/1999/xlink" width="77px"
            height="77px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml: space="preserve">
